...
export class LMEQualificationBaseDTO {
  @ApiProperty({
    description: propertyMetadata.lMEQualificationDTOQualificationDataYear.description,
    example: propertyMetadata.lMEQualificationDTOQualificationDataYear.example,
    name: propertyMetadata.lMEQualificationDTOQualificationDataYear.fieldLabels.value
  })

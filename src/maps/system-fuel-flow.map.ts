...
import { SystemFuelFlow as WorkspaceSystemFuelFlow } from '../entities/workspace/system-fuel-flow.entity';
import { SystemFuelFlowDTO } from '../dtos/system-fuel-flow.dto';

@Injectable()
export class SystemFuelFlowMap extends BaseMap<
  SystemFuelFlow | WorkspaceSystemFuelFlow,
  SystemFuelFlowDTO
> {
  public async one(entity: SystemFuelFlow): Promise<SystemFuelFlowDTO> {
    return {
      ...
      systemFuelFlowUnitsOfMeasureCode: entity.systemFuelFlowUOMCode,

...
export class MonitorPlanCommentService {
  ...
  async createComment(monPlanId: string, payload: MonitorPlanCommentBaseDTO, userId: string): Promise<MonitorPlanCommentDTO> {
  ...
  async updateComment(monPlanId: string, payload: MonitorPlanCommentBaseDTO, userId: string): Promise<MonitorPlanCommentDTO> {
    const comment = await this.getCommentsByPlanIdCommentBD(monPlanId,payload.monitoringPlanComment,payload.beginDate );
  ...
  async createOrUpdateComments(plan: UpdateMonitorPlanDTO,
    userId: string, monitorPlanId: string): Promise<MonitorPlanCommentDTO> {
      const promises = [];
